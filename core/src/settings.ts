...
export const L2_VRF_SERVICE_NAME = 'VRF_L2'
...
export const L2_LISTENER_VRF_LATEST_QUEUE_NAME = `${DEPLOYMENT_NAME}-listener-vrf-l2-latest-queue`
...
export const L2_LISTENER_VRF_HISTORY_QUEUE_NAME = `${DEPLOYMENT_NAME}-listener-vrf-l2-history-queue`
...
export const L2_LISTENER_VRF_PROCESS_EVENT_QUEUE_NAME = `${DEPLOYMENT_NAME}-listener-vrf-l2-process-event-queue`
...
export const L2_WORKER_VRF_QUEUE_NAME = `${DEPLOYMENT_NAME}-worker-vrf-l2-queue`
...
export const L2_REPORTER_VRF_QUEUE_NAME = `${DEPLOYMENT_NAME}-reporter-vrf-l2-queue`
...
export const L2_VRF_LISTENER_STATE_NAME = `${DEPLOYMENT_NAME}-listener-vrf-l2-state`
...
export const L2_VRF_REPORTER_STATE_NAME = `${DEPLOYMENT_NAME}-reporter-vrf-l2-state`
