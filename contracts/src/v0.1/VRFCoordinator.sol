...
contract VRFCoordinator is ConfirmedOwner, TypeAndVersionInterface, VRFCoordinatorInterface {
     ...
     */
    function ownerCancelSubscription(uint64 subId) external view onlyOwner {
        if (s_subscriptionConfigs[subId].owner == address(0)) {
            revert InvalidSubscription();
        }
        // cancelSubscriptionHelper(subId, s_subscriptionConfigs[subId].owner); FIXME
    }
