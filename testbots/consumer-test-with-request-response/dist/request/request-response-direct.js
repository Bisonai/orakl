...
let jsonResult = [];
const jsonPath = "./tmp/request/request-response-direct.json";
...
async function sendRequestRandomWords(numberOfRequest) {
    ...
    try {
        ...
        await Promise.all(requests.map(async (request) => {
            try {
                const txReceipt = await sendTransaction(wallet, RR_CONSUMER, payload, gasLimit);
...
//# sourceMappingURL=request-response-direct.js.map