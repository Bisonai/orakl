...
curl get "https://config.orakl.network/aggregator/default/btc-usdt.aggregator.json" > /app/contracts/v0.1/scripts/tmp/btc-usdt.aggregator.json
...
jq '.bulk[0].aggregatorSource = "/app/tmp/updated-btc-usdt.aggregator.json"' /app/contracts/v0.1/scripts/tmp/bulk.json > /app/contracts/v0.1/scripts/tmp/updated_bulk.json