...
func TestAggregate(t *testing.T) {
	...
	assert.Nil(t, err)
	fmt.Println(latestByAggregatorIdResult.Timestamp)
	fmt.Println(latestByAggregatorIdResult.Value)
	mtmp, _ := json.Marshal(latestByAggregatorIdResult)
	fmt.Println(string(mtmp))
