...
- Run nodejs api and goapi with same db connection url
- If both applications is up and running, execute following command

```
go test ./scripts/ -run TestConsistency
```

## Run docker-compose from local environment

- Change api service's docker image into go-apis
...
- Run commands from go-api folder
